...
namespace RomVaultX {
	public partial class frmMain : Form {
		...
		private void chkBoxShowCorrect_CheckedChanged(object sender, EventArgs e) => DatSetSelected(DirTree.Selected);

		private void chkBoxShowMissing_CheckedChanged(object sender, EventArgs e) => DatSetSelected(DirTree.Selected);
		...
		private void frmMain_FormClosing(object sender, FormClosingEventArgs e) => VDrive.UnMount(vDriveLetter);
		...
		private Point SPoint(int x, int y) => new Point((int)(x * _scaleFactorX), (int)(y * _scaleFactorY));

		private Size SSize(int x, int y) => new Size((int)(x * _scaleFactorX), (int)(y * _scaleFactorY));
		...
		private void GameGrid_SelectionChanged(object sender, EventArgs e) => UpdateSelectedGame();
		...
		private void RomGrid_SelectionChanged(object sender, EventArgs e) => RomGrid.ClearSelection();

		#endregion

		private void scanADirToolStripMenuItem_Click(object sender, EventArgs e) => SetScanDir(false);

		private void scanWithDeleteToolStripMenuItem_Click(object sender, EventArgs e) => SetScanDir(true);
