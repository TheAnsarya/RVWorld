...
namespace RomVaultCore {
	public class bgwProgress {
		public bgwProgress(int Progress) => this.Progress = Progress;
	...
	public class bgwText2 {
		public bgwText2(string Text) => this.Text = Text;

		public string Text { get; }
	}

	public class bgwText3 {
		public bgwText3(string Text) => this.Text = Text;
	...
	public class bgwSetRange2 {
		public bgwSetRange2(int MaxVal) => this.MaxVal = MaxVal;
	...
	public class bgwShowFixError {
		public bgwShowFixError(string FixError) => this.FixError = FixError;
