...
namespace RomVaultCore.RvDB {
	...
	public static class DBHelper {
		...
		public static int DatCompare(RvDat var1, RvDat var2) {
			var retv = Math.Sign(string.Compare(var1.GetData(RvDat.DatData.DatRootFullName), var2.GetData(RvDat.DatData.DatRootFullName), StringComparison.CurrentCultureIgnoreCase));
			if (retv != 0) {
				return retv;
			}
