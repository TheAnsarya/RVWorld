...
namespace FileHeaderReader {
	...
	public static class FileHeaderReader {
		...
		static FileHeaderReader() => Detectors = new List<Detector>
			{
		...
		public static bool AltHeaderFile(HeaderFileType fileType) => (fileType == HeaderFileType.A7800) ||
