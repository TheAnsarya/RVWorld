	...
	internal class CBZip2OutputStream : Stream {
        ...
        */
		...
		private void SendMTFValues() {
			var len = CBZip2InputStream.InitCharArray(BZip2Constants.N_GROUPS, BZip2Constants.MAX_ALPHA_SIZE);
			...
			var rfreq = CBZip2InputStream.InitIntArray(BZip2Constants.N_GROUPS, BZip2Constants.MAX_ALPHA_SIZE);
            ...
            */
			...
			var code = CBZip2InputStream.InitIntArray(BZip2Constants.N_GROUPS, BZip2Constants.MAX_ALPHA_SIZE);
        ...
        */
		private readonly int[] incs = { 1, 4, 13, 40, 121, 364, 1093, 3280,
