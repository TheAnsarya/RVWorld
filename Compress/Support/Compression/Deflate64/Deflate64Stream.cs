...
namespace Compress.Support.Compression.Deflate64 {
	...
	public sealed class Deflate64Stream : Stream {
		...
		public override long Seek(long offset, SeekOrigin origin) => throw new NotSupportedException("Deflate64: not supported");

		public override void SetLength(long value) => throw new NotSupportedException("Deflate64: not supported");
		...
		private static void ThrowStreamClosedException() => throw new ObjectDisposedException(null, "Deflate64: stream has been disposed");
		...
		[MethodImpl(MethodImplOptions.NoInlining)]
		private static void ThrowCannotReadFromDeflateManagedStreamException() => throw new InvalidOperationException("Deflate64: cannot read from this stream");
		...
		[MethodImpl(MethodImplOptions.NoInlining)]
		private static void ThrowCannotWriteToDeflateManagedStreamException() => throw new InvalidOperationException("Deflate64: cannot write to this stream");

		public override void Write(byte[] array, int offset, int count) => ThrowCannotWriteToDeflateManagedStreamException();
