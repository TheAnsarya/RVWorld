...
namespace Compress.SevenZip {
	public partial class SevenZ {
		...
		public ZipReturn ZipFileCreate(string newFilename) => ZipFileCreate(newFilename, SevenZipCompressType.lzma);

		public ZipReturn ZipFileCreateFromUncompressedSize(string newFilename, SevenZipCompressType ctype, ulong unCompressedSize) => ZipFileCreate(newFilename, ctype, GetDictionarySizeFromUncompressedSize(unCompressedSize));
